...
from openbb_guru.standard_models.senate_trading import (
    SenateTradingData,
    SenateTradingQueryParams,
)
...
class FMPSenateTradingFetcher(
    Fetcher[FMPSenateTradingQueryParams, List[FMPSenateTradingData]]
):
