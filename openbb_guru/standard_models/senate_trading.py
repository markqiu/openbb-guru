...
class SenateTradingData(Data):
    ...
    first_name: Optional[str] = Field(default=None, description="Senator's first name.")
    last_name: Optional[str] = Field(default=None, description="Senator's last name.")
    office: Optional[str] = Field(default=None, description="Senator's office.")
    ...
    owner: Optional[str] = Field(default=None, description="Owner of the transaction.")
    ...
    type: Optional[str] = Field(default=None, description="Type of the transaction.")
