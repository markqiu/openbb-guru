...
class HouseDisclosureRSSFeedQueryParams(QueryParams):
    ...
    page: Optional[int] = Field(
        None, description="The page number of the RSS feed.", ge=0
    )
...
class HouseDisclosureRSSFeedData(Data):
    ...
    capital_gains_over_200_usd: Optional[str] = Field(
        None, description="Whether the capital gains exceed 200 USD."
    )
