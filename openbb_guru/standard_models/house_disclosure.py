...
class HouseDisclosureQueryParams(QueryParams):
    ...
    symbol: str = Field(
        ..., description=QUERY_DESCRIPTIONS.get("symbol", "The symbol of the company.")
    )
...
class HouseDisclosureData(Data):
    ...
    representative: str = Field(
        description="The representative associated with the transaction."
    )
    ...
    capital_gains_over_200_usd: Optional[bool] = Field(
        default=None, description="Whether the capital gains exceed 200 USD."
    )
